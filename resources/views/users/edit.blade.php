...
@elseif(auth()->user()->is_admin == 2)
    @include('includes.sidebar_creator')
...
@endif
    ...
    @csrf
            ...
            <div class="form-group">
                ...
                <select id="country" name="country"class="form-select js-select2" data-search="on" data-placeholder="Select option">
    <option value="{{ $user->country }}" data-capital="Kabul">{{ $user->country }}</option>    
