                                            ...
                                            <div class="card-inner">
                                                <div class="card-title-group align-start mb-3">
                                                    <div class="card-title">
                                                        <h6 class="title">Employer Overview</h6>
                            ...
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between">
                                    ...
                                    <div class="nk-block-head-content">
                                        ...
                                        <h3 class="nk-block-title page-title">Employer List</h3>
            ...
            @foreach ($data as $key => $user)
                    <tr>
                       <td>{{ $user->name }}</td>
                        ...
                        <td>
            <!-- <a class="btn btn-sm btn-success btn-block" href="{{ url('users/show',$user->id) }}">Show</a> -->
</td> <td>
            <a class="btn btn-sm btn-info btn-block" href="{{ url('users.edit',$user->id) }}">Edit</a>
            </td>      <td> <form action="{{ url('users.destroy', $user->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
